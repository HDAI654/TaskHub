...
class GetProjectService:
    ...
    async def execute(self, access_token: str, project_id: str) -> PrjEntity:
        logger.info("Getting project: project_id=%s", project_id)
        ...
        logger.info("Project retrieved successfully: project_id=%s", project_id)
        return project
