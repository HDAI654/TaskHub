...
class GetColumnService:
    ...
    async def execute(self, access_token: str, column_id: str) -> ColumnEntity:
        logger.info("Getting column: column_id=%s", column_id)
        ...
        if user_role is None:
            ...
            raise PermissionDenied("You don't have access to this column")

        logger.info("Column retrieved successfully: column_id=%s", column_id)
        return column
