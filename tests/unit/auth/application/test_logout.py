...
class TestLogout:
    ...
    async def test_logout_success(self, user, service, encoder, token_repo, decoder):
        access_token = encoder.create_access_token(user_id=user.id)
        refresh_token = encoder.create_refresh_token(user_id=user.id)
    ...
    async def test_logout_with_invalid_tokens(self, user, service, encoder):
        access_token = encoder.create_access_token(user_id=user.id)
        refresh_token = encoder.create_refresh_token(user_id=ID())
